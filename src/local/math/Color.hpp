...
#ifndef    page_math_Color_hpp
#   define page_math_Color_hpp
...
#	include "fwd.hpp" // {,Hsv,Rgb{,a},Ycbcr}Color, DefaultType
#	include "Matrix.hpp"
#	include "Vector.hpp"
...
#	undef DECLARE_BINARY_ARITHMETIC_OPERATOR
#	undef DECLARE_UNARY_ARITHMETIC_OPERATOR
#	undef DECLARE_BINARY_LOGICAL_OPERATOR
#	undef DECLARE_UNARY_LOGICAL_OPERATOR
...
#	undef DECLARE_OPERATORS
	...
	template <typename Char, typename CharTraits, typename D, unsigned n, typename T> std::basic_ostream<Char, CharTraits> &operator <<(std::basic_ostream<Char, CharTraits> &, const BasicColor<D, n, T> &);
	template <typename Char, typename CharTraits, typename D, unsigned n, typename T> std::basic_istream<Char, CharTraits> &operator >>(std::basic_istream<Char, CharTraits> &, BasicColor<D, n, T> &);
