...
////////// free functions //////////////////////////////////////////////////////
	...
	template <unsigned n, typename T, ENABLE_IF_IMPL(n != 4)> Vector<n, T> ZeroVector()
	{
		return Vector<n, T>(0);
	}

	template <unsigned n, typename T, ENABLE_IF_IMPL(n == 4)> Vector<n, T> ZeroVector(T w)
	{
		return Vector<n, T>(0, w);
	}

	template <unsigned n, typename T, ENABLE_IF_IMPL(n != 4)> Vector<n, T> ScaleVector()
	{
		return Vector<n, T>(1);
	}

	template <unsigned n, typename T, ENABLE_IF_IMPL(n == 4)> Vector<n, T> ScaleVector(T w)
	{
		return Vector<n, T>(1, w);
	}

	template <unsigned n, typename T, ENABLE_IF_IMPL(n != 4)> Vector<n, T> NormVector()
	{
		Vector<n, T> r;
		r[n - 1] = 1;
		return r;
	...
	template <unsigned n, typename T, ENABLE_IF_IMPL(n == 4)> Vector<n, T> NormVector(T w)
	{
		return Vector<n, T>(0, 0, 1, w);
	}

	template <unsigned n, typename T, ENABLE_IF_IMPL(n == 2 || n == 3)> Vector<n, T> UpVector()
	{
		Vector<n, T> r;
		r[1] = 1;
		return r;
	...
	template <unsigned n, typename T, ENABLE_IF_IMPL(n == 4)> Vector<n, T> UpVector(T w)
	{
