...
namespace page
{
	...
	{
		/**
		 * @weakgroup deserialize-delimiter-normalize
		 * @{
		 */
		template <typename Char, typename CharTraits>
			typename DeserializationDelimiter<Char, CharTraits>::Type
			DeserializationDelimiter<Char, CharTraits>::Normalize(
		...
		{
			return Normalize(Convert<Char, CharTraits>(s));
		}
		template <typename Char, typename CharTraits>
			template <typename String>
			typename DeserializationDelimiter<Char, CharTraits>::Type
