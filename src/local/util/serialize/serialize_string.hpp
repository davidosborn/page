...
#ifndef    page_local_util_serialize_serialize_string_hpp
#   define page_local_util_serialize_serialize_string_hpp
...
namespace page
{
	namespace util
	{
		 ...
		 */
		/**
		 * Serialize to @c std::basic_string by forwarding to the stream
