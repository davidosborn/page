...
{
	/**
	 * @note When the byte-order is not specified as part of the encoding, it
	 *       should be determined by checking for the existence of a BOM,
	...
	enum class CharEncoding
	{
		 ...
		 *
		 * @note This encoding is partially specified -- it depends on the data
		 *       type for resolution.
		 */
		defaultForType,
