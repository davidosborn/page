...
#ifndef    page_util_string_convert_hpp
#   define page_util_string_convert_hpp
...
namespace page
{
	namespace util
	{
		...
		/**
		 * Converts a string to a different character encoding, with the same
		 * flags for input and output.
		 *
		 * @throws err::Exception<err::ConversionTag>
		 */
		template <
			typename ToChar,
