...
#ifndef    page_local_aud_channel_SpacialChannel_hpp
#   define page_local_aud_channel_SpacialChannel_hpp
...
namespace page
{
	...
	namespace aud
	{
		struct SpacialChannel : virtual Channel
		{
			// construct
			explicit SpacialChannel(const phys::Sound &);
