...
#ifndef    page_local_res_fmt_bmp_hpp
#   define page_local_res_fmt_bmp_hpp
...
#	pragma pack(pop)
		...
		typedef fmt::BITMAPFILEHEADER BITMAPFILEHEADER;
		typedef fmt::BITMAPINFOHEADER BITMAPINFOHEADER;
	}
}
